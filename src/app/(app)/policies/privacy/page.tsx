  ...
  return (
    <div>
      <div className="container mx-auto px-4 py-8">
        ...
        <h3 className="text-3xl font-bold mb-4">Interpretation</h3>
        <p className="mb-4">
        ...
        <h3 className="text-3xl font-bold mb-4">Definitions</h3>
        ...
        <ul className="space-y-1 list-disc list-inside mb-8">
          ...
          <li>
            ...
            this Agreement) refers to 2Runes.gg.
          </li>
          <li>
          ...
          <li>
            <strong>Website</strong> refers to 2Runes.gg, accessible from{' '}
            <Link
              href="https://2Runes.gg"
              className="text-blue-600 dark:text-blue-500 hover:underline"
              prefetch={false}
            >
              https://2Runes.gg
        ...
        <h3 className="text-3xl font-bold mb-4">Types of Data Collected</h3>
        <h4 className="text-2xl font-bold mb-4">Personal Data</h4>
        <p className="mb-4">
        ...
        <h3 className="text-3xl font-bold mb-4">Use of Your Personal Data</h3>
        <p className="mb-4">
        ...
        <h3 className="text-3xl font-bold mb-4">Delete Your Personal Data</h3>
        <p className="mb-4">
        ...
        <h4 className="text-2xl font-bold mb-4">Business Transactions</h4>
        <p className="mb-4">
        ...
        <h4 className="text-2xl font-bold mb-4">Law enforcement</h4>
        <p className="mb-4">
        ...
        <h4 className="text-2xl font-bold mb-4">Other legal requirements</h4>
        <p className="mb-4">
        ...
        <h2 className="text-4xl font-bold mb-4">Links to Other Websites</h2>
        <p className="mb-4">
