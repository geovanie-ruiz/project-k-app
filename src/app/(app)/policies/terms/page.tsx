    ...
    <div>
      <div className="container mx-auto px-4 py-8">
        ...
        <p className="mb-4">
          ...
          not endorse or sponsor this project. Riot Games®, Project K, set names
          and images, logos, names and all associated marks are trademarks of
          Riot Games. All other trademarks are the property of the respective
          trademark owners.
        </p>
        <p className="mb-4">
